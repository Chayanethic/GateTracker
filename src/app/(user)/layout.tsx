...
import { LayoutDashboard, BookOpen, User, LogOut, Hexagon, Target, Activity, ClipboardCheck, ArrowLeftRight, Trophy, Moon, Timer } from 'lucide-react';
...
export default function UserLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    ...
    { name: 'Topic Time Mirror', href: '/topic-tracker', icon: Timer },
