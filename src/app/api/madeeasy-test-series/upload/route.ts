...
export async function POST(req: Request) {
  try {
    ...
    const provider = 'madeeasy';
    const allowedCategories = new Set(['topicwise', 'subjectwise', 'full_syllabus', 'standard']);
    const testCategory = allowedCategories.has(String(b.testCategory || '')) && String(b.testCategory || '') !== 'standard' ? String(b.testCategory) : 'full_syllabus';
